			...
			<div style="display:;">
				<dl>
					<dd>
						...
						<input class="btn" type="button" value="가입하기" onclick="location.href='member_join.do?jointype=일반'"> 
					</dd>
					<br>
					<dd>
						<strong>[ 사업자회원 ]</strong> 사업자등록증을 보유한 회원 
						<input class="btn" type="button" value="가입하기" onclick="location.href='member_join.do?jointype=사업자'">
					</dd>
					<dd>
