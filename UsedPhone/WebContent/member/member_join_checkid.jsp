<%@page import="dao.B_MemberDAO"%>
<%@page import="dao.G_MemberDAO"%>
...
<%
        ...
        response.setCharacterEncoding("utf-8");
       	...
       	if ( paramId != "" && !(paramId.indexOf(" ") >= 0) &&
       		...
       		resultB = B_MemberDAO.getInstance().checkId( paramId );
       		resultG = G_MemberDAO.getInstance().checkId( paramId );
       	}
       	...
       	pageContext.setAttribute("resultB", resultB);
       	pageContext.setAttribute("resultG", resultG);
...
<!DOCTYPE html>
	...
	<body>
		<c:choose>
			<c:when test="${ resultB and resultG }">
